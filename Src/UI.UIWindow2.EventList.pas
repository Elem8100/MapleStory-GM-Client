...
procedure CreateEventListForm;
begin
  const Path = 'UI.wz/UIWindow2.img/EventList/main/';
  CreateForm(Path + 'backgrnd', 417, 200);
  CreateButton('EventListFormClose', 'UI.wz/Basic.img/BtClose3', 394, 5);
  UIButton['EventListFormClose'].OnMouseDown :=
    procedure(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer)
    begin
      UIForm['UI.wz/UIWindow2.img/EventList/main/backgrnd'].Visible := False;
    end;
  ...
  CreateImage('EventListVScr', 'UI.wz/Basic.img/VScr9/enabled/base', 1, 30.5, 395, 90);
  CreateImage('EventListVScr/prev0', 'UI.wz/Basic.img/VScr9/enabled/prev0', 1, 1, 395, 87);
  CreateImage('EventListVScr/next0', 'UI.wz/Basic.img/VScr9/enabled/next0', 1, 1, 395, 448);
  CreateImage('EventListVScr/thumb0', 'UI.wz/Basic.img/VScr9/enabled/thumb0', 1, 1, 395, 98);
end;
