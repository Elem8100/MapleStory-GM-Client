object SoulEffectForm: TSoulEffectForm
  Left = 0
  Top = 0
  Caption = 'SoulEffectForm'
  ClientHeight = 553
  ClientWidth = 339
  Color = clBtnFace
  ...
  PixelsPerInch = 120
  TextHeight = 16
  object SoulEffectGrid: TAdvStringGrid
    ...
    TabOrder = 0
    OnClick = SoulEffectGridClick
    HoverRowCells = [hcNormal, hcSelected]
    OnClickCell = SoulEffectGridClickCell
